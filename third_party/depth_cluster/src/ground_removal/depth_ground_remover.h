...
class DepthGroundRemover {
 public:
  ...
  virtual ~DepthGroundRemover() = default;
   ...
   */
  void OnNewObjectReceived(const Cloud& cloud, cv::Mat& no_ground_image);
 ...
 protected:
   ...
   */
  cv::Mat RepairDepthRow(const cv::Mat& no_ground_image, int step,
                      float depth_threshold);

  cv::Mat RepairDepthCol(const cv::Mat& no_ground_image, int step,
                      float depth_threshold);
