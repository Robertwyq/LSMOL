...
#include "clusterers/image_based_clusterer_v2.h"
...
void ReadData(const Radians& angle_tollerance, const string& in_path,
  ...
  ImageBasedClusterer_v2<LinearImageLabeler<>> clusterer(
      angle_tollerance, 0.5f, min_cluster_size, max_cluster_size);
