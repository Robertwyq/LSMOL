...
def main(waymo_root,split,output_dir,token, process_num):
...
if __name__ == "__main__":
    ...
    if args.process>1:
        ...
        for token in range(args.process):
            result = pool.apply_async(main, args=(args.waymo_root,args.split,args.output_dir, token, args.process))
        pool.close()
        pool.join()
    else:
        main(args.waymo_root,args.split,args.output_dir, 0, args.process)
